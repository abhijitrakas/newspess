...
if ( ! function_exists( 'newspress_setup' ) ) :
	...
	function newspress_setup() {
		 ...
		 * If you're building a theme based on newspress, use a find and replace
		 * to change 'newspress' to the name of your theme in all the template files.
		 */
...
function newspress_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'newspress_content_width', 640 );
}
...
function newspress_scripts() {
	...
	wp_enqueue_script( 'newspress-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'newspress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
